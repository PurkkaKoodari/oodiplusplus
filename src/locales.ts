...
export const LOCALES: MapObj<Locale> = {
        ...
        messages: {
            ...
            "schedule.actions.color": "Väritä",
            "schedule.actions.color.tooltip": "Klikkaa asettaksesi aktiviteetin värin",
            "schedule.actions.color.eyedropper": "Valitse väri aktiviteetista",
            "schedule.actions.color.eyedropper.tooltip": "Klikkaa valitaksesi tämän aktiviteetin väri",
            "schedule.actions.color.remove": "Poista väri",
            "schedule.actions.color.remove.tooltip": "Klikkaa poistaaksesi aktiviteetin värin",
            "schedule.actions.exportIcal": "Vie iCal-tiedostoon",
            "schedule.actions.remove": "Poista",
            "schedule.actions.remove.tooltip": "Klikkaa poistaaksesi aktiviteetin",
...
%u \u2013 WebOodi-URL`,
    ...
    en: {
        ...
        messages: {
            ...
            "schedule.actions.color": "Color",
            "schedule.actions.color.tooltip": "Click to set the activity's color",
            "schedule.actions.color.eyedropper": "Color from activity",
            "schedule.actions.color.eyedropper.tooltip": "Click to pick this activity's color",
            "schedule.actions.color.remove": "Uncolor",
            "schedule.actions.color.remove.tooltip": "Click to remove the activity's color",
            "schedule.actions.exportIcal": "Export iCal",
            "schedule.actions.remove": "Remove",
            "schedule.actions.remove.tooltip": "Click to remove the activity",
